...
const DummyComponent = props => (
    <MobileDrawer alignment='left' is_open title='Menu' height='100vh' width='295px'>
        <MobileDrawer.Body>
            <MobileDrawer.Item>
                <p>Menu item 1</p>
            </MobileDrawer.Item>
    ...
    <MobileDrawer alignment='left' is_open>
        <MobileDrawer.Body>
            <MobileDrawer.SubMenu
                ...
                onToggle={() => {}}
            >
                <MobileDrawer.SubMenuSection section_icon={'IcStage2'} section_title={'SubMenu Section'}>
