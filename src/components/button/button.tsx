...
import IcAddBold from 'assets/icons/common/ic-add-bold.svg';
import IcCheckmark from 'assets/icons/common/ic-checkmark.svg';
...
const Button = ({
    ...
    const button = (
        ...
        >
            ...
            {is_submit_success && (
                <img src={IcCheckmark} className={classNames('dc-icon', 'dc-icon--active')} width={24} height={24} />
            )}
            {is_plus && (
                <img src={IcAddBold} className={classNames('dc-icon', 'dc-icon--black')} width={18} height={18} />
            )}
