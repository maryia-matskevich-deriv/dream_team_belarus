...
import './popover.scss';
import IcInfoBlue from 'assets/icons/common/ic-info-blue.svg';
import IcInfoOutline from 'assets/icons/common/ic-info-outline.svg';
import IcUnknown from 'assets/icons/common/ic-unknown.svg';
                ...
                <TinyPopover
                    ...
                    {...(relative_render
                        ? {
                              ...
                              contentLocation: ({ childRect: targetRect, popoverRect, nudgedLeft }) => {
                                ...
                                >
                                    {!disable_message_icon && icon === 'info' && (
                                        <i className='dc-popover__bubble__icon'>
                                            <img src={IcInfoBlue} alt='ic-info-blue' />
                                        </i>
                                    )}
                                    {(has_error && (
                    ...
                    <div className={classNames('dc-popover', className)} id={id}>
                        <div className={classNames(classNameTarget, 'dc-popover__target')}>
                            {!disable_target_icon && (
                                ...
                                >
                                    {icon === 'info' && (
                                        <img src={IcInfoOutline} className={icon_class_name} alt='ic-info-outline' />
                                    )}
                                    {icon === 'question' && (
