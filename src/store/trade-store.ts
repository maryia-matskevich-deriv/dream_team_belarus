...
import { isDigitContractType, isDigitTradeType } from './trading/Helpers/digits';
import ServerTime from 'api/base/server_time';
import { processPurchase } from './trading/Actions/purchase';
import * as Symbol from './trading/Actions/symbol';
